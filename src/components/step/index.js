...
const Step = ({title, heading, description, img, alternate, firstpoint, SecondPoint,ThirdPoint, ForthPoint, FifithPoint, SixthPoint}) => {
    ...
    return (
        <div className={alternate?row : rowReverse}>
          <div className="lg:w-2/6 lg:-ml-20 lg:-mt-10 lg:flex lg:flex-col lg:justify-center lg:items-start">
            ...
            <ul className="text-gray-400 lg:w-6/6 lg:text-left">
              <li>{firstpoint}</li>
              <li>{SecondPoint}</li>
              <li>{ThirdPoint}</li>
              <li>{ForthPoint}</li>
